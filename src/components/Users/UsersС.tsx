...
export default class Users extends React.Component<UsersPropsType> {
    ...
    render() {
        ...
        return <div>
            ...
            {pages.map(c => {
                return <button
                    onClick={(e)=>{this.onPageChanged(c)}}
                    className={this.props.currentPage === c ? styles.selectedPage : ""}>{c}</button>
            })}
